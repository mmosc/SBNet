...
def read_data(FLAGS):
    ...
    if FLAGS.split_type == 'voice_only':
        ...
        test_file_anc = '/share/hel/datasets/voxceleb/sbnet_feats/data/face/facenet_AncFaceTest.csv'
        test_anc = pd.read_csv(test_file_anc, header=None)
        print('Reading Face Test PosNeg')
        test_file_neg = '/share/hel/datasets/voxceleb/sbnet_feats/data/face/facenet_veriflist_test_random_unseenunheard.csv'
        test_neg = pd.read_csv(test_file_neg, header=None)
        ...
        test_file_face = '/share/hel/datasets/voxceleb/sbnet_feats/data/face/facenet_face_veriflist_test_random_unseenunheard.csv'
        test_file_voice = '/share/hel/datasets/voxceleb/sbnet_feats/data/voice/voice_veriflist_test_random_unseenunheard.csv'
